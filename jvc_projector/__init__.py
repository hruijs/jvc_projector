...
class Commands(Enum):
    ...
    # Anamorphic
    an1 = b"\x21\x89\x01\x49\x4E\x56\x53\x30\x0A"
    an2 = b"\x21\x89\x01\x49\x4E\x56\x53\x31\x0A"
    an3 = b"\x21\x89\x01\x49\x4E\x56\x53\x32\x0A"
    an4 = b"\x21\x89\x01\x49\x4E\x56\x53\x33\x0A"
    an5 = b"\x21\x89\x01\x49\x4E\x56\x53\x34\x0A"
